...
# =========================
    ...
    def _sog_smash_gate(r):
        ...
        try:
            if float(r.get("Drought_SOG", 0) or 0) >= 2:
                return True
            if float(r.get("Reg_Gap_S10", 0) or 0) >= 2.0:
                return True
        except Exception:
            pass
        ...
        try:
            ...
            share = float((r.get("Player_5v5_SOG_Share", None) if r.get("Player_5v5_SOG_Share", None) not in (None, "") else r.get("5v5_SOG_Share", 0)) or 0)
    ...
    <div class="wl-card wl-accent-orange">
      ...
      <div style="margin-top:6px;font-size:12px;opacity:0.92;line-height:1.2;">{meta_s}</div>
        ...
        try:
            reg_gap = float(r.get("Reg_Gap_S10", 0) or 0)
        ...
        with st.expander("Why it fires", expanded=False):
            ...
            try:
                ...
                share = r.get("Player_5v5_SOG_Share", None) if r.get("Player_5v5_SOG_Share", None) not in (None, "") else r.get("5v5_SOG_Share", None)
